...
VizChemoton allows the **visualization of chemical reaction networks (CRNs)** generated with [Chemoton](https://github.com/qcscine/chemoton) 
...
the exploration parameters (method, basis set ...). 
